...
//         [HttpPost("convertTis620ToUtf8")]
//         public IActionResult ConvertTis620ToUtf8([FromBody] string tis620Text)
//         {
//             if (string.IsNullOrEmpty(tis620Text))
//             {
//                 return BadRequest("Input string cannot be empty.");
//             }

//             // Convert TIS-620 text to UTF-8
//             Encoding tis620 = Encoding.GetEncoding("TIS-620");
//             Encoding utf8 = Encoding.UTF8;

//             byte[] tis620Bytes = tis620.GetBytes(tis620Text);
//             byte[] utf8Bytes = Encoding.Convert(tis620, utf8, tis620Bytes);

//             // Return UTF-8 encoded content as a downloadable file
